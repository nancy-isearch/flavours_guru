...
class ControllerCheckoutGuest extends Controller {
	...
	public function save() {
		...
		if (!$json) {
			...
			if ((utf8_strlen(trim($this->request->post['email'])) > 96) || !filter_var(trim($this->request->post['email']), FILTER_VALIDATE_EMAIL)) {
				$json['error']['email'] = $this->language->get('error_email');
			}
			$data['currencyCode'] = $this->session->data['currency'];

			if (!is_numeric(trim($this->request->post['telephone'])) || (utf8_strlen(trim($this->request->post['telephone'])) !=10 && $data['currencyCode']=='INR') || (utf8_strlen(trim($this->request->post['telephone'])) !=15 && $data['currencyCode']!='INR')) {
		...
		if (!$json) {
			...
			$this->session->data['guest']['mr_mrs'] = $this->request->post['mr_mrs'];
		...
		/*	$this->session->data['guest']['lastname'] = $this->request->post['lastname'];*/
			...
			$this->session->data['guest']['phone_code'] = trim($this->request->post['phone_code']);
			...
			$this->session->data['payment_mrmrs']['mr_mrs'] = $this->request->post['mr_mrs'];
			...
			$this->session->data['payment_phonecode']['phone_code'] = $this->request->post['phone_code'];
