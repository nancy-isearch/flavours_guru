<?php
class ControllerCommonHelper extends Controller {
	private $error = array();

	public function index() {
		 $this->load->language('information/contact');

		$this->document->setTitle($this->language->get('Help Us'));
		...
		/*if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			$msg = '<table width="100%" border="0" align="left" cellpadding="0" cellspacing="0" style="width:450px; border-top:1px solid #efefef; border-right:1px solid #efefef;">
				<tr>
				 ...
				 <tr>
				   <th style="padding:5px; font-size:13px; font-family:Arial, Helvetica, sans-serif; border-bottom:1px solid #efefef; border-left:1px solid #efefef;" align="left" valign="middle">Email</td>
				   <td style="padding:5px; font-size:13px; font-family:Arial, Helvetica, sans-serif; border-bottom:1px solid #efefef; border-left:1px solid #efefef;" align="left" valign="middle">'.$this->request->post['email'].'</td>
				 </tr>
				 <tr>
			...
			$mail->send();
			 ...
			 $this->response->redirect($this->url->link('common/helper/success'));
		}*/
		...
		$data['breadcrumbs'][] = array(
			'text' => $this->language->get('Help Us'),
			'href' => $this->url->link('common/helper')
		);

		$data['heading_title'] = $this->language->get('Help Us');
		...
		$data['action'] = $this->url->link('common/helper','',true);
		//$data['helperaction'] = $this->url->link('information/contact', '',true);
		...
		$this->response->setOutput($this->load->view('common/helper', $data));
	}
