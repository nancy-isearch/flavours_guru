...
class ControllerAccountAddress extends Controller {
	...
	protected function getForm($val) {
		$data['breadcrumbs'] = array();
		...
		$data['text_edit_address'] = $this->language->get(''.$val.' Address');
		...
		$data['entry_address_1'] = $this->language->get('Address');
	...
	protected function validateForm() {
		...
		*/
		...
		/*if ($country_info && $country_info['postcode_required'] && (utf8_strlen(trim($this->request->post['postcode'])) !=6)) {
			$this->error['postcode'] = $this->language->get('error_postcode');
		}*/

		if ( utf8_strlen(trim($this->request->post['postcode'])) !=6 || !is_numeric($this->request->post['postcode'])) {
			$this->error['postcode'] = 'Pincode must be 6 characters and numeric!';
		}
