...
exit;*/
			foreach ($products as $product) {
				...
				$data['products'][] = array(
					...
					'shipping_price' => $this->currency->format($product['shipping_price']+($this->config->get('config_tax') ? $product['tax'] : 0), $order_info['currency_code'], $order_info['currency_value']),
