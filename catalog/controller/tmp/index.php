...
class ControllerTmpIndex extends Controller {
	...
	public function updateCategoryMeta(){
		die;
		$cats=$this->db->query("select d.category_id, d.name, d.meta_title, d.meta_description, d.meta_keyword, m.parent_id from oc_category_multiparent m inner join oc_category_description d ON d.category_id = m.category_id where m.parent_id = 69;")->rows;
		...
		foreach($cats as $cat){
			...
			$name = $cat['name'];
			$city = "Gurgaon";
			if (preg_match('/in (.+?) Gurgaon$/', $name, $matches)) {
				$area = $matches[1];
				$catNmae = "Online Cake Delivery in ".$area.", ".$city."";
				$metaTitle = "Online Cake Delivery in ".$area.", ".$city." | 100% Eggless Cakes | Midnight & Same-Day Delivery";
				$metaDescription = "Order cake online in ".$area.", ".$city." with same-day & midnight delivery. Fresh, eggless cakes for birthdays, anniversaries & special occasions.";
				$body = "<h3>Why Order Cakes Online in ".$area.", ".$city."?</h3><p>Make your celebrations sweeter with <b>online cake delivery in ".$area.", ".$city."</b>. Whether it’s a birthday, anniversary, festival, or just a sweet craving, get <b>fresh, eggless cakes delivered</b> to your doorstep quickly and safely.</p><p><b>Why Choose Us?</b></p><ul><li>Same Day & Midnight Cake Delivery in ".$area.", ".$city."</li><li>Freshly Baked, 100% Eggless Cakes</li><li>Flat ₹100 Off for First-Time Customers</li><li>Safe & Hygienic Packaging and Delivery</li><h3>Celebrate Special Moments with Online Cake Delivery in ".$area.", ".$city."</h3><p>Send cakes to friends, family, or colleagues across <b>".$area.", ".$city.".</b> We deliver in all major areas like <b>[Nearby Localities/Sectors]</b>, making it easy to surprise your loved ones.</p><p><b>Popular Cakes:</b></p><ul><li>Chocolate Truffle</li><li>Red Velvet</li><li>Butterscotch Crunch</li><li>Fresh Fruit Cake</li><li>Designer Cakes</li><li>Photo Cakes</li><li>Fondant Cakes</li></ul><h3>Kids' Birthday Cakes in ".$area.", ".$city."</h3><p>Make your kid’s birthday extra special with <b>custom cakes in ".$area.", ".$city.".</b> We offer cartoon cakes, superhero designs, and number cakes—all eggless and safe for children.</p><p><b>Trending Kids Cakes:</b></p><ul><li><a target='_blank' href='https://www.flavoursguru.com/superhero-fondant-cake-p417'>Superhero Cakes</a> (Spiderman, Avengers)</li><li><a target='_blank' href='https://www.flavoursguru.com/my-barbie-cake-p3472'>Barbie</a> & Princess Cakes</li><li>Jungle & Animal Theme Cakes</li><li>Unicorn & <a target='_blank' href='https://www.flavoursguru.com/cartoon-cakes/peppa-pig'>Peppa Pig Cakes</a></li><li>Car & Sports Cakes</li><li>Number & Alphabet Cakes</li></ul><h3>Valentine’s Day Cakes in ".$area.", ".$city."</h3><p>Celebrate love with our <b>Valentine’s Day special cakes in ".$area.", ".$city."</b>. Order online for same-day or midnight delivery and make your day memorable.</p><p><b>Romantic Cake Ideas:</b></p><ul><li><a href='https://www.flavoursguru.com/red-velvet-heart-cake-p143' target='_blank'>Heart-Shaped Red Velvet</a></li><li><a href='https://www.flavoursguru.com/regular-cakes/chocolate-cakes' target='_blank'>Chocolate Cakes with Rose Toppers</a></li><li><a href='https://www.flavoursguru.com/photo-cakes' target='_blank'>Personalized Photo Cakes</a></li><li><a href='https://www.flavoursguru.com/fondant-cakes' target='_blank'>Fondant Couple Cakes</a></li></ul><h3>Same Day & Midnight Cake Delivery in ".$area.", ".$city."</h3><p>Need a cake today? We offer:</p><ul><li>Same Day Cake Delivery in ".$area.", ".$city."</li><li>Midnight Cake Delivery in ".$area.", ".$city."</li></ul><p>Perfect for last-minute parties or midnight surprises.</p><h3>Order Cake Online in ".$area.", ".$city." for Every Occasion</h3><p>We deliver cakes in ".$area.", ".$city." for all events and festivals:</p><ul><li>Birthdays & Anniversaries</li><li>Baby Showers & Farewells</li><li>Valentine’s Day & Mother’s Day</li><li><a href='https://www.flavoursguru.com/rakhi/cakes-for-rakhi' target='_blank'>Raksha Bandhan</a>, <a href='https://www.flavoursguru.com/diwali' target='_blank'>Diwali</a>, Christmas, New Year</li></ul><h3>FAQs – Online Cake Delivery in ".$area.", ".$city."</h3><div class='mb-3'><h4>Do you offer same-day cake delivery in ".$area.", ".$city."?</h4><div class='faq-ans-col'><p>Yes, same-day delivery is available. Order early to get it delivered on time.</p></div></div><div class='mb-3'><h4>Can I get midnight cake delivery in ".$area.", ".$city."?</h4><div class='faq-ans-col'><p>Yes, midnight delivery is available. Place your order before 10 PM.</p></div></div><div class='mb-3'><h4>Are your cakes eggless?</h4><div class='faq-ans-col'><p>Yes, all cakes are 100% eggless.</p></div></div><div class='mb-3'><h4>Do you offer photo cakes in ".$area.", ".$city."?</h4><div class='faq-ans-col'><p>Yes, we make <a target='_blank' href='https://www.flavoursguru.com/photo-cakes'>custom photo cakes</a>. Upload your photo during checkout.</p></div></div><div class='mb-3'><h4> What occasions do you deliver cakes for?</h4><div class='faq-ans-col'><p>We cover birthdays, anniversaries, corporate events, farewells, and festivals.</p></div></div><div class='mb-3'><h4>Is free delivery available in ".$area.", ".$city."?</h4><div class='faq-ans-col'><p>Free delivery is available for orders placed before 8 PM. Midnight deliveries may have extra charges.</p></div></div><div class='mb-3'><h4>How do I place a cake order online?</h4><div class='faq-ans-col'><p>Select your cake, choose the delivery time, add your message, and confirm the order.</p></div></div><div class='mb-3'><h4>Do you deliver cakes to offices and schools in ".$area.", ".$city."?</h4><div class='faq-ans-col'><p>Yes, we deliver to homes, offices, schools, and commercial addresses.</p></div></div>";

				//echo "UPDATE oc_category_description set name='".$this->db->escape($catNmae)."', description='".$this->db->escape($body)."', meta_title='".$this->db->escape($metaTitle)."', meta_description='".$this->db->escape($metaDescription)."' where category_id=".$cat["category_id"]; die;
				$this->db->query("UPDATE oc_category_description set name='".$this->db->escape($catNmae)."', description='".$this->db->escape($body)."', meta_title='".$this->db->escape($metaTitle)."', meta_description='".$this->db->escape($metaDescription)."' where category_id=".$cat["category_id"]);
