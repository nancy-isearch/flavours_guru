<?php
class ControllerInformationCorporate extends Controller {
	private $error = array();
...
//echo "<pre />"; print_r($_POST); die;
			...
			$mail->addAttachment("tmp/customize/".$file_name);
			$mail->setTo('sharique@flavoursguru.com');

			$mail->setFrom($this->config->get('config_email'));
			$mail->setSender(html_entity_decode($this->request->post['name'], ENT_QUOTES, 'UTF-8'));
		//	$mail->setSubject(html_entity_decode(sprintf($this->language->get('email_subject'), $this->request->post['name']), ENT_QUOTES, 'UTF-8'));
			$mail->setSubject(html_entity_decode(sprintf('Corporate Query', $this->request->post['name']), ENT_QUOTES, 'UTF-8'));
			$msg = '<table width="100%" border="0" align="left" cellpadding="0" cellspacing="0" style="width:450px; border-top:1px solid #efefef; border-right:1px solid #efefef;">
				<tr>
				 ...
				 <tr>
				   <th style="padding:5px; font-size:13px; font-family:Arial, Helvetica, sans-serif; border-bottom:1px solid #efefef; border-left:1px solid #efefef;" align="left" valign="middle" scope="col">Email</th>
				   <td style="padding:5px; font-size:13px; font-family:Arial, Helvetica, sans-serif; border-bottom:1px solid #efefef; border-left:1px solid #efefef;" align="left" valign="middle" scope="col">'.$this->request->post['email'].'</th>
				 </tr>
				 <tr>
		...
		$data['breadcrumbs'][] = array(
			'text' => "Corporate Cake",
			'href' => $this->url->link('information/corporate')
		);
		...
		$data['action'] = $this->url->link('information/corporate', '', true);
		...
		$this->response->setOutput($this->load->view('information/corporate', $data));
	}
