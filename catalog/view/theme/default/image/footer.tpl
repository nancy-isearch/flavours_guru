<footer>
	<div id="advanced-newsletter-box">
        ...
        <div class="input-group box-newsletter-subscribe" id="mail-box">
        	...
        	<a href="#"><img src="catalog/view/theme/default/image/fb-icon.png" alt="Facebook" /></a>
        	<a href="#"><img src="catalog/view/theme/default/image/twitter-icon.png" alt="Twitter" /></a>
        	<a href="#"><img src="catalog/view/theme/default/image/pintrest-icon.png" alt="Pintrest" /></a>
        	<a href="#"><img src="catalog/view/theme/default/image/google-icon.png" alt="Google Plus" /></a>
        </div>
                </div>
                <div class="footer-col">
