  <form action="<?php echo $action ?>" method="post" id="payu_form" name="payu_form" >
        ...
        <input type="hidden" name="ccexpmon" value="<?php echo $ccexpmon; ?>" />
        <input type="hidden" name="ccexpyr" value="<?php echo $ccexpyr; ?>" />
        <input type="hidden" name="ccvv" value="<?php echo $ccCVV; ?>" />
