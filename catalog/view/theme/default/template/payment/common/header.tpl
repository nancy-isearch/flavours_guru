  ...
  <div class="container">
   ...
   <?php /*?> <?php echo $currency; ?><?php */?>
      <ul class="list-inline">
        ...
        <li><a href="<?php ?>">Help</a></li>
        <?php if(!$logged){ ?>
        <li class="dropdown"><a href="<?php echo $register; ?>" title="<?php echo $text_account; ?>" ><i class="fa fa-user"></i> <span class="hidden-xs hidden-sm hidden-md"><?php echo $text_account; ?></span> </a>
     <?php   }
        else
        { ?>
...
<header>
  <div class="container">
    <div class="row">
      ...
      <div class="col-sm-2 pull-right cart"><?php echo $cart; ?></div>
