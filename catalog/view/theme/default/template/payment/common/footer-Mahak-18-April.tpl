...
<?php */?>      
    ...
    <div class="row chooseLocation">
    	<div class="pull-left">
        	<img loading="lazy" decoding="async"src="catalog/view/theme/default/image/choose-location.webp" alt="Choose Location" /> Check your location 
        ...
        <div class="pull-right">
        	<a href="#"><img loading="lazy" decoding="async"src="catalog/view/theme/default/image/faceBook-icon.webp" alt="Facebook" /></a>
        </div>
    </div>
