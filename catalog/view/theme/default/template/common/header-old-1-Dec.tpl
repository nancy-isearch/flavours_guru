...
$.src='https://v2.zopim.com/?4x22BtON1aKUr97S6ymsnXXJ6fQFJf7B';z.t=+new Date;$.
type='text/javascript';e.parentNode.insertBefore($,e)})(document,'script');
</script>
<!--End of Zendesk Chat Script-->

<!-- Hotjar Tracking Code for www.bookmyflowers.com -->
<script>
    (function(h,o,t,j,a,r){
        h.hj=h.hj||function(){(h.hj.q=h.hj.q||[]).push(arguments)};
        h._hjSettings={hjid:639613,hjsv:5};
...
<div id="offerBanner" style="display:none;"><div class="container"><strong>Special Offer</strong> - Flat 10% off on Flowers, Cakes, Gifts & Combos    Use Coupon Code: <strong class="offerCode">BMF10</strong> <span>X</span></div></div>
     ...
     <?php   }
      ...
      <?php   } ?>
        <li><a href="#"><span class="webRupee"></span> <?php echo $currency; ?> </a></li>
      	<?php /*<li>Shipping to: <img src="catalog/view/theme/default/image/india-flag.jpg" alt="India" /></li>*/ ?>
