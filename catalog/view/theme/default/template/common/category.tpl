  ...
  <div class="row">
    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
      ...
      <div class="row">
        ...
        <?php } ?>
        <!-- <?php if ($description) { ?>
        <div class="col-sm-10 catDescription"><?php echo $description; ?></div>
        <?php } ?> -->
      </div>
      <hr>
      <?php } ?>
      ...
      <div class="row toolbar">
       ...
       <div class="col-md-8 col-sm-6 responseFilter">  <?php echo $column_left; ?> </div>
          ...
          <div class="product-thumb">
            ...
            <div>
              ...
              <div class="button-group"  >
                 <a class="anchor" target="_self" href="<?php echo $product['href']; ?>"  >  <span class="hidden-xs hidden-sm hidden-md"><?php echo $button_cart; ?></span></a> 
     ...
     <?php /*?>   <div class="col-sm-6 text-right"><?php echo $results; ?></div> <?php */?>
      </div>
      <?php } ?>
      ...
      <?php if ($description) { ?>
        <div class="col-sm-10 catDescription" id="catDescription">
...
{
  var  descriptionData =  "<?php echo $description ?>";
  if(descriptionData.length)
  {
    var screenwidth = $(window).width();
    if(screenwidth < 1024){
    var ab = $("#catDescription").html();
    var abclen = $("#catDescription").html().length;
    var abcsub = $("#catDescription").html().substring(0,300);
    var appendstr = $("#catDescription").html('').append(""+abcsub+"<button      id='show'>Read More</button> ");
    $("#show").click(function(){   
     $("#catDescription").html(ab).append("<button id='hidetext'>Read Less</button>");
    });
    $('body').on('click','#hidetext',function() {
    $("#catDescription").html(""+abcsub+"<button id='show'>Read More</button>");
    });
