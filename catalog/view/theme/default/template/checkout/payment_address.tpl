<form class="form-horizontal senderDetailsAdd">
  <?php if ($addresses) { ?>
  <!-- <div class="radio">
    <label>
  ...
  <div class="radio">
    <label>
      <input type="radio" name="payment_address" style="     visibility: hidden;" value="new" checked="checked" />
      <?php //echo $text_address_new; ?></label>
  </div>
  <?php } ?>

  <br />
  <div id="payment-new" style="display: block<?php echo ($addresses ? 'none' : 'block'); ?>;">
    ...
    <div class="form-group">
      <label class="col-sm-2 control-label" for="input-payment-company"><?php echo $entry_email; ?></label>
      <div class="col-sm-12">
    ...
    <div class="form-group">
      <label class="col-sm-2 control-label" for="input-payment-company"><?php echo $entry_telephone; ?></label>
      <div class="col-sm-12">
        <input type="number" name="telephone" value="<?php echo $mobile;?>" placeholder="<?php echo $entry_telephone; ?>" id="input-payment-telephone" class="form-control" />
        <span id="errortelephoneMsg"></span>
      </div>
    </div>
...
<script type="text/javascript">
            ...
            /*$('#input-payment-telephone').keypress(function(e) {
              var a = [];
                var k = e.which;
                a.push(8);
                for (i = 48; i < 58; i++)
...
$(document).ready(function(){
   $("#input-payment-telephone").focusout(function(){
    ...
    if(textLength>10 || textLength<10){ 
     // var element = $('#input-payment-telephone');
      
   // $( "#input-payment-telephone > div" ).text( "bPlease enter 10 digit valid number" );
      //$("#errortelephoneMsg").text("Please enter 10 digit valid number").css("color","red");
    }else{
       $("#errortelephoneMsg").text("").css("color","");
    }
  }); 
}); 
...
<!-- <script> 
$('#input-payment-email').blur(function(){
