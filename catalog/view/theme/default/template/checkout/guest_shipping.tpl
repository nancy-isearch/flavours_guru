...
<form class="form-horizontal col-md-12 col-sm-12 col-xs-12 p-r-0 p-l-0">
  ...
  <div class="form-group required">
    <label class="col-sm-2 control-label" for="input-shipping-firstname">Recipient's <?php  echo $entry_firstname; ?></label>
    <div class="col-sm-10">
      <div class="display-flex width-100-per">
          ...
          <input type="text" name="firstname" value="<?php echo $firstname; ?>" placeholder="<?php echo $entry_firstname; ?>" id="input-shipping-firstname" class="form-control  gueast-name-input" />
      </div>
    </div>
  </div>
  ...
  <div class="form-group required">
    <label class="col-sm-2 control-label" for="input-shipping-phone">Recipient's Phone</label>
    <div class="col-sm-10">
      <div class="display-flex width-100-per">
          <select class="select-name-before form-control" name="phone_code" id="phone_code">
            <option value="+91">+91</option>
          </select>
          <input type="number" name="phone" value="<?php echo $phone; ?>" placeholder="Phone" id="input-shipping-phone" pattern='[0–9]*' inputmode='decimal' class="form-control gueast-name-input" />
      </div>
    </div>
  </div>
  <div class="form-group required">
    <label class="col-sm-2 control-label" for="input-shipping-address-1">Recipient's <?php echo $entry_address_1; ?></label>
    <div class="col-sm-10">
      <input type="text" name="address_1" value="<?php echo $address_1; ?>" placeholder="<?php echo $entry_address_1; ?>" id="input-shipping-address-1" class="form-control" autocomplete="new-password" />
    </div>
  </div>
  <div class="form-group required">
  ...
  <div class="form-group required">
    <label class="col-sm-2 control-label" for="input-shipping-postcode"><span class="starrequired">* </span><?php echo $entry_postcode; ?></label>
    <div class="col-sm-10">
  ...
  <div class="col-sm-5 rec-col-2 mess-form">
    ...
    <label style="display: none;" class="col-sm-2 control-label mess-label" for="cake_message">Cake Message</label>
    <input style="display: none;" type="text" name="gift_message" class="form-control gift_message" maxlength="30" value="<?php echo $gift_message; ?>">
    <div style="display: none;" class='message-limit'>Maximum Character Limit <span>30</span></div>
    ...
    <input type="text" name="card_message" class="form-control card_message" maxlength="250" value="<?php echo $card_message; ?>">

    <label class="col-sm-2 control-label mess-label" for="special_instruction">Special instruction</label>
    <input type="text" name="special_instruction" class="form-control special_instruction" maxlength="100" value="<?php echo $special_instruction; ?>">
    ...
    <div class="sender_detail_col col-md-12 col-sm-12 col-xs-12">
      ...
      <div class="form-group required col-xs-6" style="margin-bottom: 5px;">
        ...
        <div class="col-sm-12">
          <input type="number" name="sender_phone" value="<?php echo $sender_phone; ?>" placeholder="Sender Phone" id="input-shipping-sender-phone" inputmode='decimal' pattern='[0–9]*' class="form-control" />
        </div>
      </div>
