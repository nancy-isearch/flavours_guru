<div class="row">
  <div class="col-sm-12 guestSender">
    <fieldset id="account">
      ...
      <div class="form-group required test1">
        <label class="control-label" for="input-payment-firstname"><?php echo 'Name'; ?></label>
   ...
   <!--<div class="form-group required">
      ...
      <div class="form-group required">
        ...
        <input type="number" pattern='[0–9]*' inputmode='decimal' name="telephone" value="<?php echo $telephone; ?>" placeholder="<?php echo $entry_telephone; ?>" id="input-payment-telephone" class="form-control" />
  ...
  <div class="col-sm-6">
   ...
   <!--    <div class="form-group">
      ...
      <div class="form-group required">
        <label class="control-label" for="input-payment-address-1"><?php echo 'Address'; ?></label>
...
$("#input-payment-telephone").focusout(function(){
   ...
   if(textLength>10 || textLength<10){
    /* console.log("Please enter 10 digit valid number");
     ...
     $("#errortelephoneMsg").text("").removeClass("text-danger");
