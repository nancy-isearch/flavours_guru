  ...
  <div class="col-sm-6">
    <fieldset id="address">
     ...
     <!--  <div class="form-group">
      ...
      <div class="form-group required">
        <label class="control-label" for="input-payment-address"><?php echo $entry_address_1; ?></label>
        <input type="text" name="address_1" value="" placeholder="<?php echo $entry_address_1; ?>" id="input-payment-address" class="form-control" />
      </div>
     <!--  <div class="form-group">
...
<div class="buttons clearfix">
  <div class="pull-left"><?php //echo $text_agree; ?> &nbsp;
    ...
    <input type="button" value="Continue" id="button-register" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-primary" />
  </div>
</div>
<?php } else { ?>
<div class="buttons clearfix">
