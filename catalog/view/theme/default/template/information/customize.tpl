          ...
          <div class="master">
            <div class="customise-slider type-one-carousel">
              <div class="type-card-wrapper">
                <div class="type-card">
                 <div class="tmls-testimonial">
                    <img src="catalog/view/theme/default/image/05-min.jpg" alt="Cake"/>
                  </div>
                </div>
              </div>
              ...
              <div class="type-card-wrapper">
                <div class="type-card">
                 <div class="tmls-testimonial">
                    <img src="catalog/view/theme/default/image/11-min.jpg" alt="Cake"/>
                  </div>
                </div>
              </div>
              <!-- <div class="type-card-wrapper">
                <div class="type-card">
                 <div class="tmls-testimonial">
                    <img src="catalog/view/theme/default/image/cust-cake3.jpg" alt="Cake"/>
                  </div>
                </div>
              </div> -->
              ...
              <div class="type-card-wrapper">
                <div class="type-card">
                <div class="tmls-testimonial">
                    <img src="catalog/view/theme/default/image/01-min.jpg" alt="Cake"/>
                  </div>
                </div>
              </div>
              ...
              <!-- <div class="type-card-wrapper">
                <div class="type-card">
                 <div class="tmls-testimonial">
                    <img src="catalog/view/theme/default/image/02-min.jpg" alt="Cake"/>
                  </div>
                </div>
              </div> -->
              ...
              <!-- <div class="type-card-wrapper">
                <div class="type-card">
                 <div class="tmls-testimonial">
                    <img src="catalog/view/theme/default/image/03-min.jpg" alt="Cake"/>
                  </div>
                </div>
              </div> -->
              <div class="type-card-wrapper">
                <div class="type-card">
                 <div class="tmls-testimonial">
                    <img src="catalog/view/theme/default/image/04-min.jpg" alt="Cake"/>
                  </div>
                </div>
              </div>
              <!-- <div class="type-card-wrapper">
                <div class="type-card">
                 <div class="tmls-testimonial">
                  <img src="catalog/view/theme/default/image/cust-cake1.jpg" alt="Cake"/>
                  </div>
                </div>
              </div>
              <div class="type-card-wrapper">
                <div class="type-card">
                 <div class="tmls-testimonial">
                    <img src="catalog/view/theme/default/image/06-min.jpg" alt="Cake"/>
                  </div>
                </div>
              </div>
              <div class="type-card-wrapper">
                <div class="type-card">
                 <div class="tmls-testimonial">
                    <img src="catalog/view/theme/default/image/07-min.jpg" alt="Cake"/>
                  </div>
                </div>
              </div>
              <div class="type-card-wrapper">
                <div class="type-card">
                 <div class="tmls-testimonial">
                    <img src="catalog/view/theme/default/image/08-min.jpg" alt="Cake"/>
                  </div>
                </div>
              </div>
              <div class="type-card-wrapper">
                <div class="type-card">
                 <div class="tmls-testimonial">
                    <img src="catalog/view/theme/default/image/09-min.jpg" alt="Cake"/>
                  </div>
                </div>
              </div>
              <div class="type-card-wrapper">
                <div class="type-card">
                 <div class="tmls-testimonial">
                    <img src="catalog/view/theme/default/image/10-min.jpg" alt="Cake"/>
                  </div>
                </div>
              </div>
              <div class="type-card-wrapper">
                <div class="type-card">
                 <div class="tmls-testimonial">
                  <img src="catalog/view/theme/default/image/cust-cake2.jpg" alt="Cake"/>
                  </div>
                </div>
              </div> -->
              <div class="slide type-card-wrapper">
                  <div class="slide-view-all-testimonial">
                    <a href="https://www.flavoursguru.com/blogs/customised-cake-images/">View All &nbsp; <img style="border: 0;" class="view-arrow" src="catalog/view/theme/default/image/Home/arrow-right-black.png" alt="" /></a>
                  </div>
              </div>
            </div>
          </div>
...
<div class="cont_ordser_email_call ">
  ...
  <div class="col-sm-12 cakebox"><img src="catalog/view/theme/default/image/cust-cake1.jpg" alt="Cake"/></div>
  <div class="col-sm-12 cakebox"><img src="catalog/view/theme/default/image/cust-cake2.jpg" alt="Cake"/></div>
  <div class="col-sm-12 cakebox"><img src="catalog/view/theme/default/image/cust-cake3.jpg" alt="Cake"/></div>  
</div>
</div> -->
