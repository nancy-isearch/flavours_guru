    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
      ...
      <div class="text-center xs-pl-15 xs-pr-15">
          ...
          <p style="margin-bottom: 20px;">
            <a href="https://www.flavoursguru.com/" class="btn btn-green">Explore Now</a>
          </p>
          <p></p>
      </div>
      <div class="col-md-12 col-sm-12 col-xs-12 p-l-0 p-r-0  xs-pl-15 xs-pr-15" style="margin-bottom: 20px;">
        <h3 style="margin-bottom: 20px;text-align: center; font-weight: 600;color: #000000;">Our Popular Categories</h3>
        <div class="search-tab-cakes">
          <ul class="d-flex">
            <li><a href="https://www.flavoursguru.com/regular-cakes">Normal Cream Cakes</a></li>
            <li><a href="https://www.flavoursguru.com/birthday">Birthday Cakes</a></li>
            <li><a href="https://www.flavoursguru.com/anniversary">Anniversary Cakes</a></li>
            <li><a href="https://www.flavoursguru.com/kids">Cake For Kids</a></li>
            <li><a href="https://www.flavoursguru.com/cartoon-cakes">Cartoon Cakes</a></li>
            <li><a href="https://www.flavoursguru.com/custom-theme-cakes">Theme Cakes</a></li>
            <li><a href="https://www.flavoursguru.com/wedding">Wedding Cakes</a></li>
            <li><a href="https://www.flavoursguru.com/bachelorette-cake">Bachelorette Cakes</a></li>
            <li><a href="https://www.flavoursguru.com/pull-me-up-cake">Pull Me Cakes</a></li>
            <li><a href="https://www.flavoursguru.com/pinata-cakes">Pinata Cakes</a></li>
            <li><a href="https://www.flavoursguru.com/cakes-by-profession">Cakes By Profession</a></li>
            <li><a href="https://www.flavoursguru.com/bomb-cake">Bomb Cakes</a></li>
          </ul>
        </div>
      </div>
...
<style type="text/css">
  ...
  .search-tab-cakes ul li a:hover {
    background:#F65F73;
    color: #ffffff; 
  }
</style>
