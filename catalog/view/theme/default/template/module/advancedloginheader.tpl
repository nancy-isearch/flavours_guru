...
<script type="text/javascript"><!--
 ...
 document.getElementById("welcome").innerHTML = '<a href="#loginpopuphead_form" title="" class="loginpopuphead"><img loading="lazy" decoding="async"alt="" src="<?php echo $thickboxbutton; ?>"/></a>';
