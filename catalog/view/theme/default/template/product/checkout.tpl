    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
      ...
      <div class="panel-group" id="accordion">
        ...
        <div class="panel panel-default">
          ...
          <div class="panel-collapse collapse" id="collapse-payment-summary">
            <div class="panel-body"></div>
          </div>
        </div>
        <div class="panel panel-default">
    ...
    $.ajax({
        ...
        success: function(html) {
			...
			if ($('input[name=\'account\']:checked').val() == 'register') {
				$('#collapse-payment-address').parent().find('.panel-heading .panel-title').html('<a href="#collapse-payment-address" data-toggle="collapse" data-parent="#accordion" class="accordion-toggle"><?php echo $text_checkout_account."/Signup "; ?><i class="fa fa-caret-down"></i></a>');
			} else {
				$('#collapse-payment-address').parent().find('.panel-heading .panel-title').html('<a href="#collapse-payment-address" data-toggle="collapse" data-parent="#accordion" class="accordion-toggle"><?php echo $text_checkout_payment_address; ?> <i class="fa fa-caret-down"></i></a>');
			}
    ...
    $.ajax({
        ...
        success: function(json) {
            ...
            if (json['redirect']) {
                ...
                $.ajax({
                    url: 'index.php?route=checkout/summary',
                    dataType: 'html',
                    complete: function() {
                    ...
                    success: function(html) {
                        ...
                        $('#collapse-payment-summary .panel-body').html(html);
                        
                        $('#collapse-payment-summary').parent().find('.panel-heading .panel-title').html('<a href="#collapse-payment-summary" data-toggle="collapse" data-parent="#accordion" class="accordion-toggle">Order Summary <i class="fa fa-caret-down"></i></a>');
                        $('#collapse-payment-summary').addClass('in');
                        //$('a[href=\'#collapse-payment-summary\']').trigger('click');
                        $('#collapse-payment-method').parent().find('.panel-heading .panel-title').html('<?php echo $text_checkout_payment_method; ?>');
...
$(document).delegate('#summary-btn', 'click', function() {
    $.ajax({
                    url: 'index.php?route=checkout/payment_method',
                    dataType: 'html',
                    complete: function() {
                    ...
                    success: function(html) {
                        ...
                        $('#collapse-checkout-confirm').parent().find('.panel-heading .panel-title').html('<?php echo $text_checkout_confirm; ?>');
                        jQuery("#verticalTabs").msTabs({tabs:'li', selected:'active', effects:'fade', defaultTab:'ccard'});
                    },
                    error: function(xhr, ajaxOptions, thrownError) {
                        alert(thrownError + "\r\n" + xhr.statusText + "\r\n" + xhr.responseText);
                    }
            ...
            if (json['redirect']) {
                ...
                $.ajax({
                    ...
                    success: function(html) {
                        ...
                        $("#collapse-checkout-confirm").find("form").submit();
