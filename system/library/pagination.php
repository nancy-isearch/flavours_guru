...
class Pagination {
	...
	public function renderMobile() {
		...
		if ($page > 1) {
			...
			if ($page - 1 === 1) {
				$output .= '<li><a href="' . str_replace(array('&amp;page={page}', '&page={page}'), '', $this->url) . '" class="prevbtn"><- Previous</a></li>';
			} else {
				$output .= '<li><a href="' . str_replace('{page}', $page - 1, $this->url) . '" class="prevbtn"><- Previous</a></li>';
			}
		}
		...
		if ($page < $num_pages) {
			$output .= '<li><a href="' . str_replace('{page}', $page + 1, $this->url) . '" class="nextbtn">Next -></a></li>';
			//$output .= '<li><a href="' . str_replace('{page}', $num_pages, $this->url) . '">' . $this->text_last . '</a></li>';
		}
