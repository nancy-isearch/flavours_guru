	...
	public function index() {
		...
		if ($this->user->isLogged() && isset($this->request->get['token']) && ($this->request->get['token'] == $this->session->data['token'])) {
			if($this->user->getGroupId() && $this->user->getGroupId() == 14){
				$this->response->redirect($this->url->link('sale/vendororder', 'token=' . $this->session->data['token'], true));
			} else if($this->user->getGroupId() && $this->user->getGroupId() == 15){
				$this->response->redirect($this->url->link('sale/boyorder', 'token=' . $this->session->data['token'], true));
			} else {
