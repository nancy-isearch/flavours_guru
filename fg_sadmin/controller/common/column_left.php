		...
		if (isset($this->request->get['token']) && isset($this->session->data['token']) && ($this->request->get['token'] == $this->session->data['token'])) {
			...
			*/	
			...
			if ($this->user->hasPermission('access', 'sale/order')) {
				$sale[] = array(
					'name'	   => 'Add Order',
					'href'     => $this->url->link('sale/order/addOrderAdmin', 'token=' . $this->session->data['token'], true),
					'children' => array()		
				);	
			}
			...
			if ($this->user->hasPermission('access', 'sale/followup')) {
				$sale[] = array(
					'name'	   => 'Follow Up',
					'href'     => $this->url->link('sale/followup', 'token=' . $this->session->data['token'], true),
					'children' => array()		
				);	
			}

			if ($this->user->hasPermission('access', 'sale/pnc')) {
				$sale[] = array(
					'name'	   => 'PNC',
					'href'     => $this->url->link('sale/pnc', 'token=' . $this->session->data['token'], true),
					'children' => array()		
				);	
			}
			...
			if ($this->user->hasPermission('access', 'sale/complaint')) {
				$sale[] = array(
					...
					'href'     => $this->url->link('sale/complaint', 'token=' . $this->session->data['token'], true),
					'children' => array()		
				);	
			}
			...
			if ($this->user->hasPermission('access', 'tool/export_import')) {
				$tool[] = array(
					...
					'href'     => $this->url->link('tool/upload_data/uploadCategoryMenu', 'token=' . $this->session->data['token'], true),
					'children' => array()		
				);
			}
			...
			if ($this->user->hasPermission('access', 'tool/export_import')) {
				$tool[] = array(
					'name'	   => "Sitemap",
					'href'     => $this->url->link('tool/upload_data/uploadSitemap', 'token=' . $this->session->data['token'], true),
					'children' => array()		
				);
			}
			...
			if ($this->user->hasPermission('access', 'tool/export_import')) {
				$tool[] = array(
					...
					'href'     => $this->url->link('tool/upload_data/uploadProMap', 'token=' . $this->session->data['token'], true),
					'children' => array()		
				);
			}
			...
			if ($this->user->hasPermission('access', 'tool/export_import')) {
				$tool[] = array(
					'name'	   => "Category Meta/Footer",
					'href'     => $this->url->link('tool/upload_data/uploadCatmeta', 'token=' . $this->session->data['token'], true),
					'children' => array()		
				);
			}
			...
			if ($this->user->hasPermission('access', 'report/sale_order_detail')) {
				$report_sale[] = array(
					'name'	   => 'Order Detail',
					'href'     => $this->url->link('report/sale_order_detail', 'token=' . $this->session->data['token'], true),
					'children' => array()
				);
			}
			...
			if ($this->user->hasPermission('access', 'shipping/cities')) {
				$shipping[] = array(
					'name'	   => $this->language->get('Shipping Pincodes'),
					'href'     => $this->url->link('shipping/cities/shippingPincode', 'token=' . $this->session->data['token'], true),
					'children' => array()
				);
			}		
			...
			if ($this->user->hasPermission('access', 'shipping/cities')) {
				$shipping[] = array(
					'name'	   => $this->language->get('Cities'),
					'href'     => $this->url->link('shipping/cities', 'token=' . $this->session->data['token'], true),
					'children' => array()
				);
			}		
			...
			if ($this->user->hasPermission('access', 'shipping/cities')) {
				$shipping[] = array(
					'name'	   => $this->language->get('Cities Group'),
					'href'     => $this->url->link('shipping/cities_group', 'token=' . $this->session->data['token'], true),
					'children' => array()
				);
			}
			...
			if ($this->user->hasPermission('access', 'shipping/cities')) {
				$shipping[] = array(
					'name'	   => $this->language->get('Time Slots'),
					'href'     => $this->url->link('shipping/timeslot', 'token=' . $this->session->data['token'], true),
					'children' => array()
				);
			}
			...
			if ($this->user->hasPermission('access', 'shipping/cities')) {
				$shipping[] = array(
					'name'	   => $this->language->get('Shipping Holidays'),
					'href'     => $this->url->link('shipping/holidays', 'token=' . $this->session->data['token'], true),
					'children' => array()
				);
			}
			...
			if ($this->user->hasPermission('access', 'shipping/cities')) {
				$shipping[] = array(
					'name'	   => $this->language->get('Shipping Type'),
					'href'     => $this->url->link('shipping/type', 'token=' . $this->session->data['token'], true),
					'children' => array()
				);
			}
			...
			if ($shipping) {	
				$data['menus'][] = array(
					'id'       => 'menu-shipping',
					'icon'	   => 'fa-bar-chart-o', 
					'name'	   => $this->language->get('Shipping'),
					'href'     => '',
					'children' => $shipping
				);	
			}
			...
			if($this->user->getGroupId() && $this->user->getGroupId() == 14){
				$data['menus'] = array();
				$data['statsshow'] = false;
			} else {
				$data['statsshow'] = true;
			}

			if($this->user->getGroupId() && $this->user->getGroupId() == 15){
				$data['menus'] = array();
				$data['statsshow15'] = false;
			} else {
				$data['statsshow15'] = true;
			}
			...
			$menutemp = true;
			$showOrder = false;
			if($this->user->getGroupId() && ($this->user->getGroupId() >= 17 && $this->user->getGroupId() <= 21)){
				$data['menus'] = array();
				$data['statsshow17'] = false;
				$menutemp = false;
				$showOrder = true;
			} else {
				$data['statsshow17'] = true;
			}
			$data['followup'] = $this->url->link('sale/followup', 'token=' . $this->session->data['token'], true);
			...
			if($showOrder){
				...
				$data['addOrderAdmin'] = $this->url->link('sale/order/addOrderAdmin', 'token=' . $this->session->data['token'], true);
			}
