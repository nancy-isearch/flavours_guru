...
class ControllerShippingType extends Controller {
	...
	protected function gettypeform() {
		...
		if (isset($this->request->post['timeslot_id'])) {
			$data['timeslotid'] = $this->request->post['timeslot_id'];
		} elseif (!empty($type_info)) {
			$data['timeslotid'] = $type_info['timeslot_id'];
		} else {
			$data['timeslotid'] = true;
		}
		...
		if (isset($this->request->post['date_added'])) {
			$data['$date'] = $this->request->post['date_added'];
		} elseif (!empty($type_info)) {
			$data['$date'] = $type_info['date_added'];
		} else {
			$data['$date'] = '';
		}
	...
	public function typeadd(){
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST')) {
			$this->model_shipping_type->addtype($this->request->post);
