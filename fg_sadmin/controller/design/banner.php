...
class ControllerDesignBanner extends Controller {
	...
	protected function getForm() {
		...
		$data['entry_endDate'] = $this->language->get('End Date');
		$data['entry_strtDate'] = $this->language->get('Start Date');
		...
		if (isset($this->request->post['strtDate'])) {
			$data['strtDate'] = $this->request->post['strtDate'];
		} else {
			$data['strtDate'] = '';
		}
