<?php
class ControllerCatalogSeomegamenu extends Controller {
	public function index() {
		...
		$data['text_autogenerators'] = $this->language->get('text_autogenerators_mm');
		$data['text_editor'] = $this->language->get('text_editor_mm');
		...
		$data['text_socialrichsnippets'] = $this->language->get('text_richsnippets');
		...
		return $this->load->view('catalog/seomegamenu.tpl', $data);
	}
}
