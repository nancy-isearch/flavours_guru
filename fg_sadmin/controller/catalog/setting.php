...
class ControllerCatalogsetting extends Controller {  
    ...
    private function getForm() {
        ...
        $data['text_manufacturer_breadcrumb'] = $this->language->get('text_manufacturer_breadcrumb'); 
        $data['help_manufacturer_breadcrumb'] = $this->language->get('help_manufacturer_breadcrumb'); 
        ...
        if (isset($this->request->post['nerdherd_manu_breadcrumblink'])) {
            $data['nerdherd_manu_breadcrumblink'] = $this->request->post['nerdherd_manu_breadcrumblink'];
        } elseif ($this->config->get('nerdherd_manu_breadcrumblink')) {
            $data['nerdherd_manu_breadcrumblink'] = $this->config->get('nerdherd_manu_breadcrumblink');
        } else {
            $data['nerdherd_manu_breadcrumblink'] = '';
        }
