...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		$data['entry_home_footer_text'] = $this->language->get('entry_home_footer_text');
		...
		if (isset($this->request->post['config_home_footer_text'])) {
			$data['config_home_footer_text'] = $this->request->post['config_home_footer_text'];
		} else {
			$data['config_home_footer_text'] = $this->config->get('config_home_footer_text');
		}
