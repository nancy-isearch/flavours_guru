...
class ModelUserUser extends Model {
	...
	public function getVendors(){
		$query = $this->db->query("SELECT * FROM `" . DB_PREFIX . "user` WHERE user_group_id = '14'");
