...
class ModelMarketingCoupon extends Model {
	...
	public function getCoupons($data = array()) {
		$sql = "SELECT coupon_id, name, code, discount, date_start, date_end, status, show_on_frontend, frontend_description FROM " . DB_PREFIX . "coupon";
