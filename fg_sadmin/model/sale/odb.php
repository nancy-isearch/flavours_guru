...
class ModelSaleOdb extends Model {
	...
	public function csvdata($data){
		...
		$sql = "SELECT f.order_id mainid, payment_firstname, payment_mobile, payment_city, payment_email, shipping_firstname, shipping_phone, shipping_city, f.date_added fdate_added, f.order_status_id fstatus, date_forshipping, is_admin_order, total FROM oc_order f where f.order_status_id >= 0 ";
