          ...
          <div class="tab-content">
            <div class="tab-pane active" id="tab-general">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <label class="radio-inline">
                    <?php if ($show_on_frontend) { ?>
                    <input type="radio" name="show_on_frontend" value="1" checked="checked" />
                    <?php echo $text_yes; ?>
                    <?php } else { ?>
                    <input type="radio" name="show_on_frontend" value="1" />
                    <?php echo $text_yes; ?>
                    <?php } ?>
                  </label>
                  <label class="radio-inline">
                    <?php if (!$show_on_frontend) { ?>
                    <input type="radio" name="show_on_frontend" value="0" checked="checked" />
                    <?php echo $text_no; ?>
                    <?php } else { ?>
                    <input type="radio" name="show_on_frontend" value="0" />
                    <?php echo $text_no; ?>
                    <?php } ?>
                  </label>
                </div>
