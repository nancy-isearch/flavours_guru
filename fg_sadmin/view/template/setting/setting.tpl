        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-setting" class="form-horizontal">
          ...
          <div class="tab-content">
            <div class="tab-pane active" id="tab-general">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-home-footer-text"><?php echo $entry_home_footer_text; ?></label>
                <div class="col-sm-10">
                  <textarea name="config_home_footer_text" rows="5" placeholder="<?php echo $entry_home_footer_text; ?>" id="input-home-footer-text" class="form-control"><?php echo $config_home_footer_text; ?></textarea>
                </div>
              </div>
              <div class="form-group">
