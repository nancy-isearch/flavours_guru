  ...
  <div class="container-fluid">
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
          ...
          <div class="row">
            ...
            <div class="col-sm-3">
              <!-- <div class="form-group">
                ...
                <div class="input-group date">
                  <input type="text" name="filter_date_modified" value="<?= $filter_date_modified; ?>" placeholder="<?= $entry_date_delivery; ?>" data-date-format="YYYY-MM-DD" id="input-date-modified" class="form-control" />
                  <span class="input-group-btn">
                  <button type="button" class="btn btn-default"><i class="fa fa-calendar"></i></button>
                  </span></div>
              </div> -->
            ...
            <div class="col-sm-3">
              <div class="form-group">
                ...
                <div class="input-group date">
                  <select name="filter_slot_delivery" id="input-slot-delivery" class="form-control">
                    <option value="*"></option>
                    <?php foreach ($allslots as $slot) { ?>
                    <?php if ($slot == $filter_slot_delivery) { ?>
                    <option value="<?= $slot; ?>" selected="selected"><?= $slot; ?></option>
                    <?php } else { ?>
            ...
            <div class="col-sm-3">
              <div class="form-group">
                <label class="control-label" for="input-order-status">Vendor</label>
                <select name="filter_order_vendor" id="input-order-vendor" class="form-control">
                  <option value="*"></option>
                  <?php foreach ($vendors as $vendor) { ?>
                  <?php if ($vendor['user_id'] == $filter_order_vendor) { ?>
                  <option value="<?= $vendor['user_id']; ?>" selected="selected"><?= $vendor['firstname'].' '.$vendor['lastname']; ?></option>
                  <?php } else { ?>
        ...
        <?php if($orderForApproval){ ?>
          <div class="table-responsive">
            <h4>Custom Orders: Ready for dispatch</h4>
            <table class="table table-bordered table-hover">
              ...
              <tbody>
                <?php foreach ($orderForApproval as $key => $value) { ?>
                  <tr>
                    <td><a href="index.php?route=sale/order/info&token=<?php echo $token; ?>&order_id=<?php echo $value['order_id']; ?>" class="btn btn-primary btn-xs"><?php echo $value['order_id'] ?></a></td>
                    <td><?php echo $value['payment_firstname'] ?></td>
                    <td><?php echo $value['added_by_name'] ?></td>
                    <td><a href="index.php?route=sale/order/approvorder&token=<?php echo $token; ?>&order_id=<?php echo $value['order_id']; ?>" class="btn btn-primary btn-xs">Approved?</a></td>
                  </tr>
                <?php } ?>
              </tbody>
            </table>
            ...
            <table class="table table-bordered table-hover">
              <thead>
                <tr>
                  ...
                  <td class="text-left"><?php if ($sort == 'o.date_added') { ?>
                    ...
                    <td class="text-left"><?php if ($sort == 'o.vendor') { ?>
                    <a href="#" class="<?= strtolower($order); ?>">Vendor</a>
                    <?php } else { ?>
                    <a href="#">Vendor</a>
                    <?php } ?></td>

                    <td class="text-left"><?php if ($sort == 'o.agent') { ?>
                    <a href="#" class="<?= strtolower($order); ?>">Agent</a>
                    <?php } else { ?>
                    <a href="#">Agent</a>
                    <?php } ?></td>
              ...
              <tbody>
                ...
                <tr bgcolor="<?=$order['rowcolor']?>">
                  ...
                  <td class="text-left"><?= $order['vendor']; ?></td>
                  <td class="text-left"><?= $order['agent']; ?></td>
...
$('#button-filter').on('click', function() {
  ...
  var filter_order_vendor = $('select[name=\'filter_order_vendor\']').val();

  if (filter_order_vendor != '*') {
    url += '&filter_order_vendor=' + encodeURIComponent(filter_order_vendor);
  }
  ...
  var filter_slot_delivery = $('select[name=\'filter_slot_delivery\']').val();
