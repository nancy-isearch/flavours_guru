          ...
          <div class="tab-content">
              ...
              <div class="form-group col-sm-12">
                <table class="table table-bordered">
                  <tr>
                    ...
                    <td><?php echo $pnc_info['payment_firstname']; ?></td>
                  </tr>
                  <tr>
                    <td><strong>Customer Email</strong></td>
                    <td><?php echo $pnc_info['payment_email']; ?></td>
                  </tr>
                  <tr>
                    <td><strong>Customer Phone</strong></td>
                    <td><?php echo $pnc_info['payment_mobile']; ?></td>
                  </tr>
                  <tr>
                    <td><strong>Cart Total</strong></td>
                    <td><?php echo $pnc_info['total']; ?></td>
                  </tr>
                  <tr>
                    <td><strong>Date Added</strong></td>
                    <td><?php echo $pnc_info['date_added']; ?></td>
                  </tr>
                  <tr>
                    <td><strong>Status</strong></td>
                    <td><?php echo $statuses[$pnc_info['pnc_status']]; ?></td>
                  </tr>
                  <tr>
                    <td><strong>Assigned To</strong></td>
                    <td><?php echo $adminusers[$pnc_info['assigned_to']]; ?></td>
                  </tr>
                </table>
                <?php if(count($pnc_comments) > 0){ ?>
                  <table class="table table-bordered">
                    <tr>
                      <th>Comment</th>
                      <th>Status</th>
                    ...
                    <?php for ($i=0; $i < count($pnc_comments); $i++) { ?>
                      <tr>
                        <td><?php echo $pnc_comments[$i]['comment'] ?></td>
                        <td><?php echo $statuses[$pnc_comments[$i]['status']] ?></td>
                        <td><?php echo $pnc_comments[$i]['date_added'] ?></td>
                        <td><?php echo $adminusers[$pnc_comments[$i]['added_by']] ?></td>
                      </tr>  
                    <?php } ?>
                  </table>
                <?php } ?>
            ...
            <div class="form-group">
              <div class="col-sm-12" style="text-align: right;">
                <input type="hidden" name="id" value="<?php echo $pnc_info['order_id']; ?>">
