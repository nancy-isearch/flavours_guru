														...
														<li>
															...
															<div class="btm-mgn">
																...
																<ul class="list-unstyled">
																	<li>/admin/language/en-gb/extension//module/endless_scroller.php</li>
																</ul>
																<em class="text-muted"><small>TO:</small></em>
																<ul class="list-unstyled">
																	<li>/admin/language/YOUR_LANGUAGE/extension/module/endless_scroller.php</li>
																</ul>
															</div>
														</li>
...
$_[&#039;text_back_to_top&#039;]  = &#039;YOUR_LANGUAGE_TRANSLATION&#039;;
        ...
        &lt;/file&gt;</code></pre>
														...
														<li>
															...
															<ul class="list-unstyled">
																<li>/catalog/language/en-gb/product/category.php</li>
																<li>/catalog/language/en-gb/product/search.php</li>
																<li>/catalog/language/en-gb/product/manufacturer.php</li>
																<li>/catalog/language/en-gb/product/special.php</li>
															</ul>
														</li>
													</ol>
												</div>
							...
							<div class="tab-content">
								...
								<div class="tab-pane" id="changelog">
									<div class="row">
										<div class="col-sm-12">
											<div class="release">
												<h3>Version 1.8.5 <small class="release-date text-muted">09 Jul 2016</small></h3>

												<blockquote>
													<ul class="list-unstyled">
														<li><em class="text-info">Fixed:</em> Support for OpenCart 2.3.0.0</li>
													</ul>
													...
													<ul>
														<li>admin/controller/extension/module/endless_scroller.php</li>
														<li>admin/language/en-gb/extension/module/endless_scroller.php</li>
														<li>admin/view/template/extension/module/endless_scroller.tpl</li>
													</ul>
