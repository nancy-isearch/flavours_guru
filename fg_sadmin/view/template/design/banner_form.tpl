              ...
              <table id="images<?php echo $language['language_id']; ?>" class="table table-striped table-bordered table-hover">
                <thead>
                  <tr>
                    ...
                    <td class="text-right"><?php echo $entry_strtDate; ?></td>
                    <td class="text-right"><?php echo $entry_endDate; ?></td>
                    <td></td>
                  </tr>
                </thead>
                <tbody>
                  ...
                  <tr id="image-row<?php echo $image_row; ?>">
                    ...
                    <td class="text-right" style="width: 10%;"><input type="text" name="banner_image[<?php echo $language['language_id']; ?>][<?php echo $image_row; ?>][sort_order]" value="<?php echo $banner_image['sort_order']; ?>" placeholder="<?php echo $entry_sort_order; ?>" class="form-control" /></td>
                     ...
                     <td class="text-right" style="width: 11%;"><input type="text" name="banner_image[<?php echo $language['language_id']; ?>][<?php echo $image_row; ?>][strtDate]" id="strtDate<?php echo $image_row; ?>" value="<?php if( $banner_image['strtDate'] != '0000-00-00' ){echo $banner_image['strtDate'];} ?>" placeholder="<?php echo $entry_strtDate; ?>" class="strtDate form-control" /></td>

                    <td class="text-right" style="width: 11%;"><input type="text" name="banner_image[<?php echo $language['language_id']; ?>][<?php echo $image_row; ?>][endDate]" id="endDate<?php echo $image_row; ?>" value="<?php if( $banner_image['endDate'] != '0000-00-00' ){echo $banner_image['endDate'];} ?>" placeholder="<?php echo $entry_endDate; ?>" class="strtDate form-control" /></td>
...
function addImage(language_id) {
	...
	html += '  <td class="text-right" style="width: 11%;"><input type="text" name="banner_image[' + language_id + '][' + image_row + '][strtDate]" value=""  placeholder="<?php echo $entry_strtDate; ?>" class="strtDate form-control" /></td>';
  html += '  <td class="text-right" style="width: 11%;"><input type="text" name="banner_image[' + language_id + '][' + image_row + '][endDate]" value="" placeholder="<?php echo $entry_endDate; ?>" class="strtDate form-control" /></td>';
