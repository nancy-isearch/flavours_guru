          ...
          <div class="tab-content">
            <div class="tab-pane active" id="tab-general">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-model">Display Name</label>
                <div class="col-sm-10">
                  <input type="text" name="display_name" value="<?php echo $display_name; ?>" placeholder="<?php echo $display_name; ?>" id="input-model" class="form-control" />
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-state"><span data-toggle="tooltip" title="Holidays">Holidays</span></label>
                <div class="col-sm-10">
                   <input type="text" name="holidays" value="<?php echo $holidays; ?>" class="form-control datea" id="datepicker2"/>
