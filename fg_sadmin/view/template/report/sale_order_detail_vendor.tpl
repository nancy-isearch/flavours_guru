...
<div id="content">
  ...
  <div>
    <div class="well" style="margin: 20px;">
      <div class="row">
        <form method="post" action="index.php?route=report/sale_order_detail_vendor/downloadcsv&token=<?php echo $token; ?>">
        <div class="col-sm-12">
  ...
  <div>
    <div class="well" style="margin: 20px;">
      <div class="row">
        <form method="post" action="index.php?route=report/sale_order_detail_vendor/downloaddeliveredordercsv&token=<?php echo $token; ?>">
        <div class="col-sm-12">
          <div class="form-group col-sm-6">
            <label class="control-label" for="input-date-start"><?php echo $entry_date_start; ?></label>
            <div class="input-group date">
          ...
          <table class="table table-bordered">
            <thead>
              <tr>
                ...
                <td class="text-left">Recipeint Name</td>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="text-left"><?php echo $order['pname']; ?></td>
...
$('#button-filter').on('click', function() {
	url = 'index.php?route=report/sale_order_detail_vendor&token=<?php echo $token; ?>';
