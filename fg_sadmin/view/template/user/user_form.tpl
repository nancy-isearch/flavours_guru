    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-user" class="form-horizontal">
          ...
          <div class="form-group">
            <label class="col-sm-2 control-label" for="input-user-group">Vendor</label>
            <div class="col-sm-10">
              <select name="vendor_id" id="input-vendor" class="form-control">
                ...
                <option value="<?php echo $vendor['user_id']; ?>" selected="selected"><?php echo $vendor['username']; ?></option>
                <?php } else { ?>
                <option value="<?php echo $vendor['user_id']; ?>"><?php echo $vendor['username']; ?></option>
                <?php } ?>
                <?php } ?>
              </select>
            </div>
