          ...
          <div class="row">
            <div class="col-sm-4">
              <div class="form-group">
                ...
                <input type="text" name="filter_name" value="<?php echo $filter_name; ?>" placeholder="Category Name" id="input-name" class="form-control" />
              </div>
              <button type="button" id="button-filter" class="btn btn-primary pull-right"><i class="fa fa-filter"></i> <?php echo 'Filter'; ?></button>
            </div>
