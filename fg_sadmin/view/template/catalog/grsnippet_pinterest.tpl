        ...
        <?php echo $text_multistoresupport; ?>
          ...
          <form action="<?php echo $action; ?>" id="form" method="post" enctype="multipart/form-data" class="form-horizontal"> 
               <div class="container-fluid">
                  ...
                  <br>
                  <fieldset>
                   <legend><img style="width: 10%;" src="view/image/seo/pinterest.png"> Pinterest Snippet</legend>
                    <div class="form-group">
                      ...
                      <div class="col-sm-10" style="display: inline-flex;">
                        <select name="grsnippetpinterest_status" class="form-control">
                          <?php if ($grsnippetpinterest_status) { ?>
          ...
          <br><br>
          <fieldset>
            <legend>Example image about how your pins shall look: </legend>
             <table class="form">
                    <tr>
                      <td class="title"><img src="view/image/seo/pin.png" alt="pinterest achievement" title="what you will achieve in pinterest"></td>
                    </tr>
             </table>
             <a href="https://www.pinterest.com/pin/578923727069144071/" target="_blank" title="Pins created by all in one seo"> See example live</a>
              </fieldset>
             <br><br>
            <fieldset class="pinterest">
            <legend>How to activate pinterest rich snippet?</legend>
             <table class="form">
                    <tr>
                      <td align="left">
