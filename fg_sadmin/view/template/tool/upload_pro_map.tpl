  ...
  <div class="container-fluid">
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        ...
        <br><br>
        <a href="<?php echo $download; ?>" class="btn btn-primary">Download Product Mapping CSV </a><br><br>
        <a href="<?php echo $download2; ?>" class="btn btn-primary">Download Category CSV </a><br><br>
        <a href="<?php echo $download3; ?>" class="btn btn-primary">Download Product Mapping Sample CSV </a><br><br>
      </div>
    </div>
  </div>
</div>
