  ...
  <div class="container-fluid">
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        ...
        <br><br>
        <a href="<?php echo $download; ?>" class="btn btn-primary">Download Category Menu CSV </a>
        <br><br>
        <p class="alert alert-info"><strong>Note:- Please do not add / in the starting of the category URLs</strong></p>
      </div>
    </div>
  </div>
</div>
